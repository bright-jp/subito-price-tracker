"""
Subito Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Subito.

Docs  : https://docs.brightdata.jp/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.jp/products/insights/price-tracker/subito
"""
...
# Set your Web Scraper ID after building your Subito scraper:
# https://brightdata.jp/products/web-scraper/subito
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Subito scraper at: https://brightdata.jp/products/web-scraper/subito\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Subito product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Subito products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Subito category page.

    Example:
        results = discover_by_category("https://subito.it/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.subito.it/product/sample-item-123456",
        # Add more Subito product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "subito_prices.json"
    ...
    # cat_results = discover_by_category("https://subito.it/category/sample", limit=50)
